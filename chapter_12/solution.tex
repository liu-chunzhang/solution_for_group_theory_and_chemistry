...
\begin{document}
	...
	\end{tabular}
	\end{center}
	By calculating the systems of linear equations, like in Problem 7.1, we obtain 	
	\begin{align}
	...
	\begin{align}
		...
		\Gamma^\pi &= \Gamma^E \oplus \Gamma^{T_1} \oplus \Gamma^{T_2} .
	\end{align}
	These equations are mentioned in the Problem and thus we are on the right way.	 Now, we know that
	\begin{equation}
	...
	\end{center}
		...
		\end{tabular}
		\end{center}
		By calculating the systems of linear equations, like in Problem 7.1, with \Tableref{table:partial_character_table_for_oh}, we obtain
		\begin{equation}
